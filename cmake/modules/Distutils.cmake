...
function(distutils_add_cython_module target name src)
  ...
  set(PY_LDSHARED ${link_launcher} ${CMAKE_C_COMPILER} ${c_compiler_arg1} "-shared" "-fuse-ld=${CMAKE_LINKER}")
...
function(distutils_install_cython_module name)
  ...
  set(PY_LDSHARED "${link_launcher} ${CMAKE_C_COMPILER} -shared -fuse-ld=${CMAKE_LINKER}")
