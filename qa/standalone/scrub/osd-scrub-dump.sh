...
# RRR change to combine the counters from all OSDs
...
# Replace dump_scrub_counters with a version that truly aggregates across OSDs
...
# create K objects in the named pool, using the same random data
