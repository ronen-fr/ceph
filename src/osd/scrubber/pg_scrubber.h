...
class PgScrubber : public ScrubPgIF,
 ...
 private:
  ...
  struct depenelize_timer_t {
    OSDService* m_osds;
    PgScrubber& m_scrbr;
    Context* m_depenalize_cb{nullptr};
    explicit depenelize_timer_t(OSDService* osds, PgScrubber* scrbr, utime_t timeout);
    ~depenelize_timer_t();
  };
  std::unique_ptr<depenelize_timer_t> m_depenalize_timer;
