...
Scrub::ScrubResources& OsdScrub::resource_bookkeeper()
{
  return m_resource_bookkeeper;
}

const Scrub::ScrubResources& OsdScrub::resource_bookkeeper() const
{
  return m_resource_bookkeeper;
}
 ...
 */
void OsdScrub::on_config_times_change()
{
  // RRR locking?
...
utime_t OsdScrub::effective_scrub_clock_now() const
{
...
{
  return scrub_time_permit(effective_scrub_clock_now());
}
