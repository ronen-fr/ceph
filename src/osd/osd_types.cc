...
std::string PastIntervals::pg_interval_t::print() const {
  return fmt::format("interval({}-{} up {}({}) acting {}({}){})", first, last,
                     up, up_primary, acting, primary,
...
namespace fmt {
template <>
struct formatter<compact_interval_t> {
  constexpr auto parse(fmt::format_parse_context& ctx) { return ctx.begin(); }
  template <typename FormatContext>
  auto format(const compact_interval_t& ci, FormatContext& ctx) const {
    return fmt::format_to(ctx.out(), "{}", ci.print());
  }
};
} // namespace fmt
...
std::string PastIntervals::print() const {
...
std::string PastIntervals::PriorSet::print() const
{
  return fmt::format("PriorSet("
                     "ec_pool: {}, "
                     "probe: {}, "
                     "down: {}, "
                     "blocked_by: {}, "
...
std::string ObjectCleanRegions::print() const
{
...
std::string ObjectRecoveryProgress::print() const {
  return fmt::format(
