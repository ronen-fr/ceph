...
struct scrub_flags_t {
  ...
  friend ostream& operator<<(ostream& out, const scrub_flags_t& sf);
};
...
class PgScrubber : public ScrubPgIF, public ScrubMachineListener {
 ...
 public:
  ...
  friend ::crimson::osd::Scrub::ScrubberBE; // our backend object
 ...
 private:
  ...
  seastar::future<> scan_rollback_obs(const vector<ghobject_t>& rollback_obs);
