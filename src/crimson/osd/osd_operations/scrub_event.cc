...
//    return interruptor::with_interruption([this, pg]() -> ScrubEvent::interruptible_future<> {
      ...
      return interruptor::with_interruption([this, pg]() /*-> ScrubEvent::interruptible_future<>*/ {
        ...
        // return this->template enter_stage<interruptor>(pp(*pg).local_sync);
        //}).then_interruptible([this, pg]() /*-> ScrubEvent::interruptible_future<> */ {
	...
	//return with_blocking_event<PGPipeline::Process::BlockingEvent>(
	  //[this, pg] (auto&& trigger)  mutable -> ScrubEvent::interruptible_future<> {
