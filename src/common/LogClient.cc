...
clog_targets_conf_t parse_log_client_options(CephContext* cct,
                                             std::string channel_name)
{
  ...
  targets.log_to_monitors =
    get_value_via_strmap(cct->_conf.get_val<string>("clog_to_monitors"),
                         channel_name, CLOG_CONFIG_DEFAULT_KEY);
...
void LogChannel::update_config_xx(map<string,string> &log_to_monitors,
