...
namespace ceph {
  ...
  public:
    ...
    /**
     * with_array_section()
     * Opens an array section and calls the function fn for each element
     * in the container.
     * Two overloads are provided:
     * 1. for maps, where the function takes a key and a value, and
     * 2. for other types of containers, where the function takes the elements
     *    of the container.
     */
    ...
    template <typename M, typename FN, typename V=std::remove_cvref_t<M>::value_type>
    requires (!is_map<M>::value && (
    std::is_invocable_r_v<void, FN, Formatter&, const V&, std::string_view> ||
     ...
     * called for each element in the container.
     *
     * Two overloads are provided:
     * 1. for maps, where the function takes a key and a value, and
     * 2. for other types of containers, where the function takes the elements
