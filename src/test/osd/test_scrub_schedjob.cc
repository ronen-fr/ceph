...
class TestScrubSchedJob : public ::testing::Test {
 public:
  ...
  //     m_dyn_data = dyn_data;
  //
  //     // the pg-info is queried for stats validity and for the
  //     last-scrub-stamp pg_info = dyn_data.mocked_pg_info;
  //
  ...
  //   {
  //     ASSERT_TRUE(m_sjob);
  //     m_sjob->init_and_queue_targets(pg_info, aconf,
  //     m_qops.scrub_clock_now());
  //   }
