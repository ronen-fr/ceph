...
static RealObj corrupt_object_size(const RealObj& s, int osdn)
{
  RealObj ret = s;
  if (osdn == 0) {
...
static CorruptFuncList crpt_funcs_set1 = {{0, &corrupt_object_size},
					  {1, &corrupt_nothing}};
...
SnapsetMockData::cooked_clone_snaps ms1_fn()
{
...
SnapsetMockData hobj_ms1_snapset{/* seq */ 0x40,
				 /* snaps */ {0x30, 0x20},
				 /* clones */ {0x20, 0x30},
				 ms1_fn};
...
ScrubGenerator::RealObjsConf /*ScrubGenerator::*/ minimal_snaps_configuration{
  /* RealObjsConf::objs */ {
    /* RealObj  */ {
