...
public:
  ...
  CephContext* get_pg_cct() const final;
  CephContext* get_osd_cct() const final;
...
{
  sbe = std::make_unique<TestScrubBackend>(test_scrubber, test_pg, i_am, false, scrub_level_t::deep, acting);
}
