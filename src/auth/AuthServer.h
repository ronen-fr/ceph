...
public:
  ...
  explicit AuthServer(CephContext *cct) : auth_registry(cct) {}
  virtual ~AuthServer() {}
...
// RRR to rm
// I'd rather create a version of AuthServer with an up-to-date API. Maybe:

// - a strong-type for peer_type
// - 
...
public:
  ...
  explicit AuthServerMod(CephContext *cct) : auth_registry{cct} {}
  virtual ~AuthServerMod() {}
